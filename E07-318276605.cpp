...
int main()
{
	...
	glm::vec3 poscoche = glm::vec3(0.0f + mainWindow.getmuevex(), -0.5f, -3.0f);
	glm::vec3 dircoche = glm::vec3(-1.0f, 0.0f, 0.0f);
	//glm::vec3 direccionluz = dircoche;
	...
	while (!mainWindow.getShouldClose())
	{
		...
		spotLights[2].SetFlash(glm::vec3(0.0f + mainWindow.getmuevex(), -0.5f, -3.0f), glm::vec3(-1.0f, 0.0f, 0.0f));
