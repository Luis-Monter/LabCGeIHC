...
int main()
{
	...
	*/
	...
	//Los ultimos 2 valores controlan la velocidad de giro con las teclas
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = glm::translate(model, glm::vec3(0.0f, -0.5f, -4.0f)); // ajustar la posición de la fachada
		model = glm::scale(model, glm::vec3(1.8f, 2.3f, 2.0f)); // ajustar el tamaño del cuadro
		...
		model = glm::translate(model, glm::vec3(-0.4f, -0.0f, -3.2f));
		model = glm::scale(model, glm::vec3(0.5f, 0.5f, 0.5f));
		...
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		model = glm::translate(model, glm::vec3(0.0f, 1.17f, -4.0f));
		...
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		model = glm::translate(model, glm::vec3(-1.3f, -1.3f, -4.0f));
		...
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		model = glm::translate(model, glm::vec3(-1.3f, -0.4f, -4.0f));
		...
		color = glm::vec3(0.0f, 1.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		model = glm::translate(model, glm::vec3(0.8f, 0.0f, -3.5f));
		model = glm::scale(model, glm::vec3(0.5f, 0.5f, 0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA
		meshList[0]->RenderMeshGeometry();

		//ventana derecha derecha
		model = glm::mat4(1.0f);
		color = glm::vec3(0.0f, 1.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		model = glm::translate(model, glm::vec3(0.8f, 0.0f, -4.5f));
		model = glm::scale(model, glm::vec3(0.5f, 0.5f, 0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA
		meshList[0]->RenderMeshGeometry();
		...
		color = glm::vec3(0.0f, 0.0f, 1.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		model = glm::translate(model, glm::vec3(0.0f, -0.5f, -4.65f));
		model = glm::scale(model, glm::vec3(0.5f, 0.5f, 0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA
		sp.render();
		...
		//piso
		model = glm::mat4(1.0f);
		color = glm::vec3(0.098f, 0.0588f, 0.6118f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		model = glm::translate(model, glm::vec3(0.0f, -1.6f, -4.0f));
		model = glm::scale(model, glm::vec3(3.5f, 0.0f, 3.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA
		meshList[0]->RenderMeshGeometry();
